...
export class createTableUserGroup1622052522053 implements MigrationInterface {
    name = 'createTableUserGroup1622052522053'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users_groups" ("id" character varying NOT NULL, "user_id" character varying NOT NULL, "group_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4644edf515e3c0b88e988522588" PRIMARY KEY ("id"))`);
